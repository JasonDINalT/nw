...
<div class="logbox">
  ...
  <a href="{logout-link}"><b>Выход</b></a>
</div>
<div id="logindialog" title="{login}" style="display:none;">
  <div class="userinfo">
	...
	[admin-link]<li><a href="{admin-link}" target="_blank"><b>Админпанель</b></a></li>[/admin-link]
        ...
        <li><a href="{pm-link}">Сообщения: ({all-pm} | {new-pm})</a></li>
...
[group=5]
<div class="logbox">
  <a class="fbutton" id="loginbtn" href="#"><b>Войти</b></a>
  ...
  <form method="post" action="">
    <div class="logform">
      <ul class="reset">
        ...
        <li class="lfield lfpas"><p><label for="login_password">Пароль (<a href="{lostpassword-link}">Забыли?</a>):</label></p><input type="password" name="login_password" id="login_password" /></li>
        <li class="lbtn"><button class="fbutton" onclick="submit();" type="submit" title="Войти"><span>Войти</span></button></li>
      </ul>
      <input name="login" type="hidden" id="login" value="submit" />
    </div>
  </form>
</div>																																																																																																																																																																																[not-page-count=1]<div style="display:none;">рекомендуем бесплатно <a href="http://newfilmak.org/">фильмы скачать</a> без регистрации и скачать <a href="http://newtemplates.ru/">dle</a> бесплатно можно скачать</div>[/not-page-count]
[/group]