<div class="bform">
<div class="dpad">
    <h2 class="bfhead">Пользователь: {usertitle} </h2>
    <div class="userinfo">
      <div class="lcol">
      ...
      <div class="rcol">
        <ul class="usinf">
          <li><span>Полное имя:</span> <b>{fullname}</b></li>
          <li><span>Группа:</span> {status} [time_limit]&nbsp;В группе до: {time_limit}[/time_limit]</li>
          <li><span>Количество публикаций:</span> <b>{news-num}</b> [{news}]</li>
          <li><span>Количество комментариев:</span> <b>{comm-num}</b> [{comments}]</li>
          <li><span>Дата регистрации:</span> <b>{registration}</b></li>
          <li><span>Последнее посещение:</span> <b>{lastdate}</b> [online]<img src="{THEME}/images/online.png" style="vertical-align: middle;" title="Пользователь Онлайн" alt="Пользователь Онлайн" />[/online][offline]<img src="{THEME}/images/offline.png" style="vertical-align: middle;" title="Пользователь offline" alt="Пользователь offline" />[/offline]</li>
          <li><span>Место жительства:</span> {land}</li>
          <li><span>Немного о себе:</span> {info}</li>
        </ul>
	...
	<div class="pheading"><h2>Редактирование профиля</h2></div>
			<table class="tableform">
				...
				<tr>
					...
					<div>
						<span class="small" style="color: #cb1919;">* Внимание! Будьте бдительны при изменении данной настройки. Доступ к Вашему аккаунту будет доступен только с того IP-адреса или подсети, который Вы укажете. Вы можете указать несколько IP адресов, по одному адресу на каждую строчку.
						<br />
